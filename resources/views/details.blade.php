      ...
      <div class="row">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumnails')}}/{{$product->image}}" width="104" height="104" alt="" /></div>
                    @foreach (explode(',', $product->images) as $gimg)
                    
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumnails')}}/{{$gimg}}" width="104" height="104" alt="" /></div>
                      @endforeach
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            ...
            <s>{{number_format($product->regular_price, 0, ',', '.')}}</s> {{number_format($product->sale_price, 0, ',' , '.')}}
            @else
          ...
          <form name="addtocart-form" method="post">
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-primary btn-addtocart js-open-aside" data-aside="cartDrawer">Thêm giỏ hàng</button>
            </div>
          </form>
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                ...
                <button
                  ...
                  data-aside="cartDrawer" title="Thêm giỏ hàng">Thêm giỏ hàng</button>
              </div>

              <div class="pc__info position-relative">
                <p class="pc__category">Dresses</p>
                <h6 class="pc__title"><a href="{{route('shop.product.details', ['product_slug'=>$product->slug])}}">Kirby T-Shirt</a></h6>
          ...
          <div class="swiper-slide product-card">
            <div class="pc__img-wrapper">
              <a href="{{route('shop.product.details', ['product_slug'=>$rproduct->slug])}}">
                ...
                <!-- ✅ Ảnh phụ (hover) -->
                @if($rproduct->images && !empty(trim($rproduct->images)))
                  @php
                    $additionalImages = explode(',', $rproduct->images);
                    $firstAdditionalImage = trim($additionalImages[0] ?? '');
                  @endphp
                  @if($firstAdditionalImage)
                    <img loading="lazy" src="{{asset('uploads/products')}}/{{$firstAdditionalImage}}" width="330" height="400"
